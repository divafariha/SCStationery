                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>";
                                echo "<a href='read.php?id=" . $row['id'] . "' title='View Record' data-toggle='tooltip'><span class='material-icons'>visibility</span></a>";
                                echo "<a href='update.php?id=" . $row['id'] . "' title='Update Record' data-toggle='tooltip'><span class='material-icons'>create</span></a>";
                                echo "<a href='delete.php?id=" . $row['id'] . "' title='Delete Record' data-toggle='tooltip'><span class='material-icons'>delete</span></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
