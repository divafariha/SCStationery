...
if (isset($_POST["id_barang"]) && !empty($_POST["id_barang"])) {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        // Set parameters
        $param_id_barang = trim($_POST["id_barang"]);
                ...
                <div class="col-6">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade show">
                            <input type="hidden" name="id_barang" value="<?php echo trim($_GET["id_barang"]); ?>" />
                            <p>Are you sure you want to delete this record?</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="index_barang.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
